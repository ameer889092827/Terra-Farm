...
export const UPGRADES: { [key: string]: Upgrade } = {
    'water_pump_1': {
        ...
        description: 'Reduces the water cost of watering plants by 20%.',
        cost: 500,
        levelRequired: 2,
    ...
    'water_tank_1': {
        id: 'water_tank_1',
        name: 'Expanded Water Tank',
        description: 'Increases your maximum water capacity from 100L to 150L.',
        cost: 750,
        levelRequired: 3,
        stat: 'water_tank',
        modifier: 150,
    ...
    'tool_efficiency_1': {
        ...
        description: 'Reduces the energy cost of all farming actions by 20%.',
        cost: 800,
        levelRequired: 4,
        stat: 'tool_efficiency',
        modifier: 0.8,
    },
    'fertilizer_mix_1': {
        id: 'fertilizer_mix_1',
        name: 'Nutrient-Rich Fertilizer',
        description: 'A special blend that permanently increases money earned from all harvests by 20%.',
        cost: 1200,
        levelRequired: 5,
        stat: 'fertilizer_mix',
        modifier: 1.2,
    ...
    'almanac_1': {
        id: 'almanac_1',
        name: 'Farming Almanac',
        description: 'An essential guide that boosts all XP gained from harvesting by 20%.',
        cost: 1000,
        levelRequired: 4,
        stat: 'almanac',
        modifier: 1.2,
